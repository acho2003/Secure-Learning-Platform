...
import { getAnnouncements, getResources, downloadResourceFile } from '../services/apiService';
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            {announcements.length === 0 && !isLoading && <p>No announcements yet.</p>}
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          ...
          <ul className="space-y-2">
            {isLoading ? <p>Loading resources...</p> : resources.map(res => (
             ...
             {resources.length === 0 && !isLoading && <p>No learning materials available.</p>}
          </ul>
        </div>
      </div>
    </DashboardLayout>
